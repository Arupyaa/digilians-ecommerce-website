...
function ProductsList({ productCount,productRow, productCategory = "" }) {
    ...
    return (
        <div className={`mx-auto w-[90%] md:w-[78%] flex flex-col md:grid md:grid-flow-col md:grid-rows-${productRow} gap-y-[20px] md:gap-[40px] py-[30px] md:py-[50px] justify-between`}>
