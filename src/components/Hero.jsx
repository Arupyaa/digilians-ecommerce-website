    ...
    return (
        <div className="mx-auto w-[90%] md:w-[78%] grid grid-flow-col grid-rows-2 md:grid-rows-3 md:gap-[40px] py-[30px] md:py-[80px]">
            <div className="md:row-span-3 self-center order-2 md:order-1">
                ...
                <button onClick={() => { navigate("/products/all/page/1") }} className="mt-3 md:mt-5 text-blue-500 bg-transparent border border-blue-500 hover:bg-blue-500 hover:text-white focus:ring-4 focus:ring-blue-200 font-medium leading-5 rounded-md text-sm px-4 py-2.5 focus:outline-none">Explore products</button>
            </div>
