...
function Hero() {
    return (
        <div className="mx-auto w-[90%] md:w-[78%] grid grid-flow-col grid-rows-6 md:grid-rows-3 md:gap-[40px] py-[30px] md:py-[80px]">
            <div className="row-span-2 md:row-span-3 self-center order-2 md:order-1">
            ...
            <div className="row-span-3 col-span-2 order-1 md:order-2">
